...
function pilihMobil(e) {
  ...
  switch (e.target.value) {
    case 'avanza.jpg':
      carImg.src = 'asset/avanza.jpeg';
      harga.textContent = '500000';
      break;
    case 'brio':
      carImg.src = 'asset/brio.jpg';
...
function displayData() {
  ...
  sewa.forEach((item, index) => {
    ...
    genderImg.src = item.gender == 'Pria' ? 'asset/dadang.jpg' : 'asset/angel.jpg';
    ...
    edit.addEventListener('click', (e) => {
      ...
      if (inputId) {
        ...
        if (sewa[index].car == 'avanza.jpeg') {
          document.getElementById('car-img-edit').src = 'asset/avanza.jpeg';
        } else if (sewa[index].car == 'brio') {
          document.getElementById('car-img-edit').src = 'asset/brio.jpg';
